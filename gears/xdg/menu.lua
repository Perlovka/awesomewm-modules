...
local function parse_menu(data, mnu, icon_theme, icon_size)
    ...
    for _,item in ipairs(data) do
        ...
        if item.Type == "submenu" then
            local sub = {}
            parse_menu(item.Items, sub, icon_theme, icon_size)
...
function menu.new_from_file(file, icon_theme, icon_size)
    ...
    local data = {}
    parse_menu(tree.Items, data, icon_theme, icon_size)
